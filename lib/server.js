...
// Mount multi-device pairing API
try {
    const multiDevicePairing = require('./multi_device_pairing');
    app.use('/api/pair', multiDevicePairing);
} catch (e) {
    console.warn('Multi-device pairing API not mounted:', e.message);
}
